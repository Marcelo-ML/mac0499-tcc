...
O software \texttt{flagmatic} (\href{https://lidicky.name/flagmatic/}) é possivelmente a implementação mais acessível e tem sido usada com êxito tipo Turán, o software {flagmatic} já foi usado e testado com resultados prolíficos em diversos problemas de densidade em grafos e hipergrafos.
...
Escolhemos esse pacote porque ele oferecia um nível suficiente de abstração e otimização para certas propriedades como normalização e produto de densidades, além de a documentação e linguagem serem mais acessíveis nas fases iniciais desse trabalho.
...
A prova desse resultado utiliza um argumento de remoção de vértices de grau mínimo baixo e também o Teorema~\ref{thm:dG-dH-blowup-C5}.