...
Os métodos utilizados no Capítulo~\ref{cap:flag-algebras} se apresentam bastante robustos e o Teorema~\ref{thm:baloghclemenlidicky} cobre os resultados do Capítulo~\ref{cap:grau-limitado}, uma vez que grafos com grau mínimo maior que $n/3$ tem mais de $n^2/6$ arestas.
