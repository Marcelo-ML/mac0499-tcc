...
\title{Sobre uma conjectura de Erd\H os acerca de grafos livres de triângulos}
\translatedtitle{On a conjecture by Erd\H os about triangle-free graphs}
...
\apoio{O presente trabalho foi realizado com apoio da Fundação de Amparo à Pesquisa do Estado de São Paulo (FAPESP), Brasil. Processos nº 2025/06707-6, 2025/14743-2}
...
\input{conteudo/preliminares}

\input{conteudo/01-resultados-classicos.tex}

\input{conteudo/02-flag-algebras.tex}

\input{conteudo/03-grau-limitado.tex}
